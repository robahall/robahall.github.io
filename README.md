This blog is set up to be tutorials using AWS for machine learning. The focus is twofold. The first is so I can reference how I set something up so I can easily repeat and understand why I did that.
